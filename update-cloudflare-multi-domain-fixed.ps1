...
# Ajouter les routes DNS pour tous les domaines
try {
...
Write-Host "   - https://www.republiqueduquebec.quebec" -ForegroundColor Cyanpour configurer le tunnel avec plusieurs domaines
...
Write-Host ""
Write-Host "4. 🔧 Demarrage automatique (optionnel):" -ForegroundColor Yellow
Write-Host "   Executez le script: .\start-app.ps1" -ForegroundColor Cyan

Write-Host ""
Write-Host "DOMAINES CONFIGURES:" -ForegroundColor Green
